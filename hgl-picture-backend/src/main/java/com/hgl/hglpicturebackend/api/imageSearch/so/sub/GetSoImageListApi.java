...
/**
 * ClassName: GetSoImageListApi
 * Package: com.hgl.hglpicturebackend.api.imageSearch.sub
 * Description: 获取360搜图搜索的图片的列表
 *
 * @Author HGL
 * @Create: 2025/4/8 18:25
 */
@Slf4j
public class GetSoImageListApi {
    ...
    public static void main(String[] args) {
        List<SoImageSearchResult> imageList = getImageList("https://ps.ssl.qhmsg.com/bdr/468_250_/t0285eb9144566d01ff.jpg", 0);
